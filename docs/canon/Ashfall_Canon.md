...
rather than guessed. Research is kept apart from decisions, in `reference/`: a
fact there is true of the real world, not of the game, until a decision here
adopts it.
...
Real-world facts (the town, its infrastructure, and the codes, equipment and
figures the systems rely on) live in `reference/`, one file per subject, each
fact with its source and the date it was checked. `reference/README.md` is the
index and the rules. Nothing there is canon until a decision here adopts it.
